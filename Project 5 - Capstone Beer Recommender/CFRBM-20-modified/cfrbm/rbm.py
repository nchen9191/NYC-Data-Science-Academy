...
class CFRBM:
    def __init__(self, num_visible, num_hidden, initial_v=None,
        ...
        if initial_weigths:
            ...
            #initial_hbias = np.array(np.random.normal(10,10, size=num_hidden),
            #                           dtype=np.float32)
            ...
            if initial_v:
                ...
                #initial_vbias = np.array(np.random.normal(10, 10, size=num_visible),
                #                       dtype=np.float32)
    ...
    def sample_visible(self, h, k=20):
